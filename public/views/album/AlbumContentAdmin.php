      ...
      <div id="album-<?php echo $album->get('album_id');?>" class="modal">
          <span onclick="document.getElementById('album-<?php echo $album->get("album_id"); ?>').style.display='none'" class="close" title="Close Modal">×</span>
              <div class="modal-container">
                  ...
                  <div class="clearfix">
                      <button type="button" onclick="document.getElementById('album-<?php echo $album->get("album_id"); ?>').style.display='none'" >Cancel</button>
                      <button type="button" onclick="deleteAlbum(<?php echo $album->get('album_id');?>)">Delete</button>
                  </div>
              </div>
      </div>
        ...
        <div id="song-<?php echo $song['song_id'];?>" class="modal">
            ...
            <div class="modal-container">
                ...
                <div class="clearfix">
                    ...
                    <button type="button" onclick="deleteSongFromAlbum(<?php echo $song['song_id'];?>, <?php echo $album->get('album_id');?>)" >Delete</button>
                </div>
            </div>
        </div>
