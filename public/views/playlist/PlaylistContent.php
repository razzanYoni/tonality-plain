...
<div class="playlist-detail-container">
  ...
  <div id="playlist-<?php echo $playlist->get('playlist_id');?>" class="modal">
      ...
      <div class="modal-container">
          ...
          <div class="clearfix">
              <button type="button" onclick="document.getElementById('playlist-<?php echo $playlist->get("playlist_id"); ?>').style.display='none'">Cancel</button>
              <button type="button" onclick="deletePlaylist(<?php echo $playlist->get('playlist_id');?>)">Delete</button>
          </div>
      </div>
  </div>
  </div>
      ...
      <td class="song-title" onclick="playAudio('<?php echo STORAGE_FOLDER . '/' . $song['audio_filename']; ?>')"><?php echo $song['title']; ?></td>
        ...
        <div id="song-<?php echo $song['song_id'];?>" class="modal">
            ...
            <div class="modal-container">
                ...
                <div class="clearfix">
                    <button type="button" onclick="document.getElementById('song-<?php echo $song["song_id"]; ?>').style.display='none'">Cancel</button>
                    <button type="button" onclick="deleteSongFromPlaylist(<?php echo $song['song_id'];?>, <?php echo $playlist->get('playlist_id');?>)" >Delete</button>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
